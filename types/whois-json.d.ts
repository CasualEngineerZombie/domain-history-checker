...
declare module "whois-json" {
    export interface WhoisJsonResult {
        registrantFax?: string | null; // Add this line
        adminAddress?: string | null;  // Add this line (or adminStreet, if that's what it should be)
        techAddress?: string | null;   // Add this line (or techStreet, if that's what it should be)
        domainName?: string;
        registrar?: string;
        registrarURL?: string;
